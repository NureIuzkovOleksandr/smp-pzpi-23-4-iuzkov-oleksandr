...
$databaseConnection = function_exists('createConnection') ? createConnection() : null;

$availableProducts = $databaseConnection && function_exists('fetchProducts') 
    ? fetchProducts($databaseConnection) 
    : [];

$errorMessage = $_SESSION['input_error'] ?? $_SESSION['inputError'] ?? '';
$previousInput = $_SESSION['input_data'] ?? $_SESSION['inputData'] ?? [];

unset($_SESSION['input_data'], $_SESSION['inputData'], $_SESSION['input_error'], $_SESSION['inputError']);
?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="number" name="cart[<?php echo $productId; ?>][quantity]" 
                            value="<?php echo htmlspecialchars($quantityValue); ?>" class="quantity-input" min="0">
